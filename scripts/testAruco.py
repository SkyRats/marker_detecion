...
if ARUCO_DICT.get(aruco, None) is None:
	print("[INFO] ArUCo tag of '{}' is not supported".format(aruco))
	sys.exit(0)

# load the ArUCo dictionary and grab the ArUCo parameters
print("[INFO] detecting '{}' tags...".format(aruco))
arucoDict = cv2.aruco.Dictionary_get(ARUCO_DICT[aruco])
